    ...
    <AboutMeWrapper>
      ...
      <div>
        <p>
          ...
          der Natur unterwegs. Der Pfühlpark, der Neckar oder der Heilbronner
          Wald waren in Laufrunden oder bei Kinderfreizeiten immer wieder meine
          Ziele. Mein Interesse an Umwelt und Natur entwickelte sich und wurde
          durch Projekte mit Umweltorganisationen gestärkt. Durch ein
          ”Freiwilliges ökologisches Jahr“ auf dem Waldheim Gaffenberg entdeckte
          ich mein Interesse an Bäumen. Nicht nur die Größe, auch ihre Eigenart
          und die vielfältigen Standorte sind immer wieder bewundernswert. So
          fasste ich den Entschluss, an der HAWK in Göttingen Arboristik zu
          studieren.
        </p>
        <p>
          Durch meinen drei Studienjahren wurden die biologischen
          Grundkenntnisse vertieft. Zum Studienprogramm gehörten Diskussionen
          über das Thema Bäume in der Stadt: Welche Aufgaben übernehmen sie?
          Welche Ansprüche haben sie? Die Fachgespräche brachten mir einen
          weiten Blick für das urbane Grün.
        </p>
        <p>
          ...
          Baumpflege und machte Praktika bei unterschiedlichen Baumpflegefirmen
          in ganz Deutschland. Die Umsetzung der Theorie in die Praxis war am
          Anfang nicht so einfach, doch langsam entwickelte sich ein anderer
          Blick. Ich konnte an den ersten Bäumen, die ich gepflegt habe, die
          Reaktionen auf meine Schnittmaßnahmen beobachten und auswerten.
        </p>
        <p>
        ...
        <p>
          ...
          anderen Baumpflegern wichtig. Er vermittelt neue Erfahrungen und
          fördert die Beschäftigung mit Forschung und Wissenschaft im
          Fachbereich Arboristik.
        </p>
        <p>
        ...
        <p>
          2016 gründete ich meine Baumpflegefirma Lemur, um den Wuchs der Bäume
          zu fördern und den besten Ausgleich zwischen Natur und Stadt, Baum und
          Mensch zu erreichen!
        </p>
